...
class JoyTeleop:
    ...
    def __init__(self):
        ...
        self.teste = rospy.Subscriber('/manual_control', Bool, self.publish_joystick_enabled)
        #print(self.teste)
        #print('ue')
        self.publishers = {}
        self.al_clients = {}
    ...
    def publish_joystick_enabled(self, msg):
        self.enable_control = msg.data 



    def joy_callback(self, data):
        #print(self.enable_control)
        if self.enable_control == True :
            try:
                #print('a')
